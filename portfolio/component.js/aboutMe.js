...
export default function AboutMe() {
  return (
    <div className='container py-10 mx-auto px-15'>
      <div className="hover:scale-115 duration-300 pb-15">
        <div className='flex justify-center'> 
              <p className="text-5xl text-center font-bold font-[poppins]">About Me</p>
        </div>
        {/* <hr className='w-60 h-1 mx-auto bg-gray-400 border-0 rounded-sm ' /> */}
      </div>
      <div className='shadow-2xl rounded-2xl'>
        <p className='text-justify font-[pT_Serif_Caption] px-20 text-xl py-10'>
        ...
        <div className="flex justify-center pb-6">
            <div className="shadow-2xl shadow-[#210F37] px-4 py-2 rounded-4xl">
                <a target='_blank' href={"https://drive.google.com/file/d/1xuE2z4uBoFkh6ayIMs9KpXpu0IkGX7cl/view?usp=sharing"} prefetch={false}>
